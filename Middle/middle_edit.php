...
.bg-img::after {
    ...
    include '../includes/connect.php';
    $query = mysqli_query($conn, "SELECT * FROM tbl_student A INNER JOIN tbl_middle B ON A.email = B.email INNER JOIN tbl_family C ON A.email= C.email  WHERE A.email='$stud_email'");
    ...
    $third_language = $row2['third_language'];
    ...
    $aadhaar = $row2['aadhaar'];
        ...
        if ($stud_living == "Guardian") {
            $query1  = mysqli_query($conn, "SELECT * FROM `tbl_guardian` WHERE email='$email' AND admission_type='Middle'");
        ...
        if ($sibling == "Yes") {
            $size=0;
            $query2  = mysqli_query($conn, "SELECT * FROM `tbl_sibling` WHERE email='$email' AND admission_type='Middle'");
   ...
   if (in_array($mark_img_ext, $extensions_pdf) === false) {
        ...
        $mark_img_path = "Uploaded Images\Marksheet/" . $mark_img_name;
            ...
            if ($er == 0) {
                ...
                $Updatequery1 =mysqli_query($conn,"UPDATE `tbl_middle` SET `passed_class`='$passed_class',`second_language`='$second_language',`third_language`='$third_language',`prev_school_name`='$prev_school_name',`prev_school_affliated`='$prev_school_affliated',`fav_subject`='$fav_subject',`study_habits`='$study_habits',`sport`='$sport',`co_curricular`='$co_curricular' WHERE email='$email'");
                $Updatequery2 =mysqli_query($conn, "UPDATE `tbl_family` SET `father_name`='$father_name',`father_qualification`='$father_qualification',`father_profession`='$father_profession',`father_phonenumber`='$father_phonenumber',`father_email`='$father_email',`father_annualincome`='$father_annualincome',`mother_name`='$mother_name',`mother_qualification`='$mother_qualification',`mother_profession`='$mother_profession',`mother_phonenumber`='$mother_phonenumber',`mother_email`='$mother_email',`mother_annualincome`='$mother_annualincome',`role_of_parent`='$role_of_parent' WHERE email='$email' AND admission_type='Middle'");
                if (is_uploaded_file($stud_img_loc) == 1) {
                    unlink($stud_photo);
                ...
                if (is_uploaded_file($mark_img_loc) == 1) {
                    unlink($marksheet);
                    $ms = mysqli_query($conn, "UPDATE `tbl_middle` SET `marksheet`='" . mysqli_real_escape_string($conn, $mark_img_path) . "' WHERE email='$email'");
                    if ($ms) {
                ...
                if (is_uploaded_file($transfer_img_loc) == 1) {
                    ...
                    $tc = mysqli_query($conn, "UPDATE `tbl_middle` SET `transfer_certificate`='" . mysqli_real_escape_string($conn, $transfer_img_path) . "' WHERE email='$email'");
                    if ($tc) {
                ...
                if (is_uploaded_file($aadhaar_img_loc) == 1) {
                    unlink($aadhaar);
                    $a = mysqli_query($conn, "UPDATE `tbl_middle` SET `aadhaar`='" . mysqli_real_escape_string($conn, $aadhaar_img_path) . "' WHERE email='$email'");
                    if ($a) {
                ...
                if ($Updatequery && $Updatequery1 && $Updatequery2) {
                    if ($sibling == "No") {
                        ...
                        if ($size != 0) {
                            for ($i = 0; $i < $size; $i++) {
                                $Updatequery3 = mysqli_query($conn, "UPDATE `tbl_sibling` SET `sibling_name`='$sibling_name[$i]',`sibling_age`='$sibling_age[$i]',`sibling_class`='$sibling_class[$i]' WHERE email='$email' AND admission_type='Middle' AND `sibling_name`= '$siblingname[$i]' ");
                            }
                        }
                    } 
                    ...
                    if ($stud_living == "Guardian") {
                        $Updatequery4 = mysqli_query($conn, "UPDATE `tbl_guardian` SET `guardian_name`='$guardian_name',`guardian_address`='$guardian_address',`guardian_email`='$guardian_email',`guardian_contact`='$guardian_phonenumber' WHERE email='$email' AND admission_type='Middle' ");
                    } else {
    ...
    <script>
            function getpassedclass() {
               ...
               if (Class == "5") {
                    document.getElementById("passedclass").value = "4";
                } else if (Class == "6") {
                    document.getElementById("passedclass").value = "5";    
                } 
                else if (Class == "7") {
                    document.getElementById("passedclass").value = "6";
                } else if (Class == "8") {
                    document.getElementById("passedclass").value = "7";
                        ...
                        <div class="col-md-10">
                                ...
                                <div class="section-title">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"><select name="class" class="form-control" id="class" onclick="getpassedclass();" value="<?php print $class; ?>">
                                                ...
                                                <?php
                                                $SELECTquery5 = mysqli_query($conn, "SELECT middle_class FROM tbl_option WHERE middle_class != '$class' AND  middle_class IS NOT NULL");
                                                while ($rw5 = mysqli_fetch_array($SELECTquery5)) {
                                                ?>
                                                    <option value="<?php echo $rw5['middle_class']; ?>"><?php echo $rw5['middle_class']; ?></option>
                                                <?php }
                                                ?>
                                            </select></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <select name="third_language" class="form-control">
                                            <option value="<?php echo $third_language; ?>"><?php echo $third_language; ?></option>
                                            <?php $SELECTquery7 = mysqli_query($conn, "SELECT `language` FROM tbl_option WHERE `language` != '$third_language' AND `language` IS NOT NULL");
                                            while ($rw7 = mysqli_fetch_array($SELECTquery7)) {
                                            ?>
                                            <option value="<?php echo $rw7['language']; ?>"><?php echo $rw7['language']; ?></option>
                                            <?php }
                                            ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <select name="prev_school_affliated" class="form-control">
                                            ...
                                            <?php
                                            $SELECTquery8 = mysqli_query($conn, "SELECT `prev_school_affliated` FROM tbl_option WHERE `prev_school_affliated` != '$prev_school_affliated' AND `prev_school_affliated` IS NOT NULL");
                                            while ($rw8 = mysqli_fetch_array($SELECTquery8)) {
                                            ?>
                                            <option value="<?php echo $rw8['prev_school_affliated']; ?>"><?php  echo $rw8['prev_school_affliated']; ?></option>
                                            <?php }
                                            ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <tr>
                                ...
                                <select name="study_habits" class="form-control">
                                            ...
                                            <?php
                                            $SELECTquery9 = mysqli_query($conn, "SELECT `study_habits` FROM tbl_option WHERE `study_habits` != '$study_habits' AND `study_habits` IS NOT NULL");
                                            while ($rw9 = mysqli_fetch_array($SELECTquery9)) {
                                            ?>
                                            <option value="<?php echo $rw9['study_habits']; ?>"><?php  echo $rw9['study_habits']; ?></option>
                                            <?php }
                                            ?></td>
                            </tr>
