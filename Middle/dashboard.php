...
$status3 = mysqli_query($conn,"SELECT stud_cstatus FROM tbl_student WHERE email = '$email'" );
   ...
   elseif($s2['cstatus']==1)
   {
	$title = "Upload Details";
        ...
        $iclass="fa fa-arrow-right";
        $location="middle_upload_details.php";
   }
   elseif($s3['stud_cstatus']==1)
   {
	$title = "Family Details";
$link = "Complete your family application";
$photo= "../images/middle_family.png";
$iclass="fa fa-arrow-right";
$location="middle_family_details.php";
   }
   else
   {
	$title = "Students Details";
$link = "Complete your application";
$photo= "../images/middle_student.png";
$iclass="fa fa-arrow-right";
$location="middle_student_details.php";
   }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="col-sm-3">
        <div class="card text-dark">
            ...
            <div class="card-img-overlay">
                ...
                <a href="middle_edit.php" style="margin-left:10px ;">Edit <i class="fa fa-edit"></i></a>
