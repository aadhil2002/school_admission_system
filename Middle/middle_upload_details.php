...
if (isset($_POST['submit'])) {
    ...
    if ($er == 0) {
        ...
        $sql1 = "UPDATE `tbl_middle` SET `marksheet` ='" . mysqli_real_escape_string($conn, $mark_img_path) . "', `transfer_certificate`= '" . mysqli_real_escape_string($conn, $transfer_img_path) . "', `aadhaar`='" . mysqli_real_escape_string($conn, $aadhaar_img_path) . "' WHERE `email`='$stud_email'";
