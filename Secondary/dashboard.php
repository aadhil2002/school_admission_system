...
$status3 = mysqli_query($conn,"SELECT stud_cstatus FROM tbl_student WHERE email = '$email'" );
   ...
   elseif($s2['cstatus']==1)
   {
	$title = "Upload Details";
        ...
        $iclass="fa fa-arrow-right";
        $location="secondary_upload_details.php";
   }
   elseif($s3['stud_cstatus']==1)
   {
	$title = "Family Details";
$link = "Complete your family application";
$photo= "../images/secondary_family.jpg";
$iclass="fa fa-arrow-right";
$location="secondary_family_details.php";
   }
   else
   {
	$title = "Students Details";
$link = "Complete your application";
$photo= "../images/secondary_student.png";
$iclass="fa fa-arrow-right";
$location="secondary_student_details.php";
   }
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="card text-dark">
            <img src="../images/edit.png" class="card-img" alt="...">
            <div class="card-img-overlay">
                <h3 class="card-title">Admission Application</h3>
                <a href="secondary_edit.php" style="margin-left:10px ;">Edit <i class="fa fa-edit"></i></a>
    ...
    <div class="col-sm-3">
        <div class="card text-dark">
            <img src="../images/status.png" class="card-img" alt="...">
            <div class="card-img-overlay">
    ...
    <div class="col-sm-3">
        <div class="card  text-dark">
            <img src="../images/complaint.png" class="card-img" alt="...">
            <div class="card-img-overlay">
...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="card text-dark">
            <img src="../images/feedback.png" class="card-img" alt="...">
            <div class="card-img-overlay">
