...
if (isset($_POST['submit'])) {
    ...
    if (is_uploaded_file($transfer_img_loc) == 0) {
        $er++;
        $etransfer_certificate = "*Please upload the file";
    ...
    if ($er == 0) {
        ...
        $sql1 = "UPDATE `tbl_primary` SET `transfer_certificate`= '" . mysqli_real_escape_string($conn, $transfer_img_path) . "', `aadhaar`='" . mysqli_real_escape_string($conn, $aadhaar_img_path) . "' WHERE `email`='$stud_email'";
