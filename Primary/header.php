    ...
    <body>
        ...
        <img src="../images/logo.png">
                ...
                <div class="header-menu">
                    <div class="title">PRIMARY ADMISSION PORTAL</div>
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="application">
                        ...
                        <div class="sub-menu">
                            <a href="primary_edit.php"><i class="fa fa-edit"></i><span>Edit</span></a>
                            <a href="rejectadmission.php"><i class="fa fa-times"></i><span>Delete</span></a>
                        </div>
                    </li>
                    <li class="item" >
