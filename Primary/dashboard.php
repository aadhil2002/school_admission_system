...
$status3 = mysqli_query($conn,"SELECT stud_cstatus FROM tbl_student WHERE email = '$email'" );
   ...
   elseif($s2['cstatus']==1)
   {
	$title = "Upload Details";
        ...
        $iclass="fa fa-arrow-right";
        $location="primary_upload_details.php";
   }
   elseif($s3['stud_cstatus']==1)
   {
	$title = "Family Details";
$link = "Complete your family application";
$photo= "../images/primary_family.png?v=<?= $version ?>";
$iclass="fa fa-arrow-right";
$location="primary_family_details.php";
   }
   else
   {
	$title = "Students Details";
$link = "Complete your application";
$photo= "../images/primary_student.png?v=<?= $version ?>";
$iclass="fa fa-arrow-right";
$location="primary_student_details.php";
   }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="col-sm-3">
        <div class="card text-dark">
            ...
            <div class="card-img-overlay">
                ...
                <a href="primary_edit.php" style="margin-left:10px ;">Edit <i class="fa fa-edit"></i></a>
