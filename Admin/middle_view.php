...
$query = mysqli_query($conn, "SELECT * FROM tbl_student A INNER JOIN tbl_middle ON A.email = B.email INNER JOIN tbl_family C ON A.email= C.email WHERE A.email='$stud_email'");
...
$stud_photo = "../Middle/" . $row1['student_photo'];
$father_photo = "../Middle/" . $row1['father_photo'];
$mother_photo = "../Middle/" . $row1['mother_photo'];
$birth_certificate = "../Middle/" . $row1['birth_certificate'];
$wellness_certificate = "../Middle/" . $row1['wellness_certificate'];
$marksheet= "../Middle/" . $row1['marksheet'];
$transfer_certificate = "../Middle/" . $row1['transfer_certificate'];
$aadhaar = "../Middle/" . $row1['aadhaar'];
                ...
                <div class="col-md-10">
                    <table class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>Active participation in the sport of</td>
                                <td><?php print $sport; ?></td>
                            </tr>

                            <tr>
                                <td>Achievements in co-curricular activities</td>
                                <td><?php print $co_curricular; ?></td>
                            </tr>
