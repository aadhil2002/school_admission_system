...
$stud_photo = "../Secondary/" . $row1['student_photo'];
$father_photo = "../Secondary/" . $row1['father_photo'];
$mother_photo = "../Secondary/" . $row1['mother_photo'];
$birth_certificate = "../Secondary/" . $row1['birth_certificate'];
$wellness_certificate = "../Secondary/" . $row1['wellness_certificate'];
$marksheet= "../Secondary/" . $row1['marksheet'];
$sport_certificate = "../Secondary/" . $row1['sport_certificate'];
$transfer_certificate = "../Secondary/" . $row1['transfer_certificate'];
$aadhaar = "../Secondary/" . $row1['aadhaar'];
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                ?>
                                    <td colspan="2">
                                        <center>
                                            <button name="sc_view">View File</button>
                                        </center>
                                    </td>
                                <?php
                                }
